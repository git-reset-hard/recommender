...
const generateUsers = (num) => {
    ...
    test_users.push(
      {
        ...
        star_pref: Math.random().toString(),
        distance_pref: Math.random().toString(),
        price_pref: Math.random().toString(),
        openness: Math.random().toString(),
  ...
  let uzers = JSON.stringify(obj);
  fs.writeFileSync('myjsonfile.json', uzers);
  console.log(uzers);
  return uzers;
}
